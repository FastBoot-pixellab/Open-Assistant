...
# Наш вебсайт для сбора датасета:
...
- [Ты хочешь?](#do-you-want-to-try-it-out)
- [Наш план](#the-plan)
- [The Vision](#the-vision)
- [Как вы можете помочь?](#how-can-you-help)
- [Я в деле! Как стать участником?](CONTRIBUTING.md)
...
<p align="center">
    Open Assistant - проект который дает каждому возможность использовать большую языковую модель!
</p>

Мы верим, что сможем совершить революцию. Как это было с **Stable Diffusion**, который помог миру рисовать красивые картины!

## Ты хочешь попробовать это?

### Стать участником сбора датасета

Фронтэнд для сбора датасета уже работает [здесь](https://open-assistant.io/). Войди и начни выполнять 
задания! Мы хотим собрать много данных.
